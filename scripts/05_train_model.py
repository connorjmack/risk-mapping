...
Trains a Random Forest classifier on assembled training data to predict
rockfall probability from pre-failure cliff morphology features.
...
Options:
    ...
    --normalize      Normalize features before training
    --group-by       Column for GroupKFold CV (e.g., 'location')
"""
...
from pc_rai.ml.train import train_model, evaluate_model


def parse_args():
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(
        description="Train Random Forest model for rockfall prediction",
...
def main():
    ...
    try:
        ...
        if verbose:
            ...
            print(f"  Metadata: {args.output.with_suffix('.json')}")
